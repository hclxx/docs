...
|     type     | string |  是  |      兑换类型:agm_to_usdt-(usdt 兑换 agm)/usdt_to_agm-(agm 兑换 usdt)       |
|     num      |  int   |  是  | 兑换数量，如 type 为 agm_to_usdt，num 为需兑换的 usdt 数量，反之为 agm 数量 |
...
```json
{
  ...
  "code": 0,
  "data": {
    "input_num": "12312" /*兑入数量*/,
    "output_num": "12312" /*兑出数量*/,
    "created_at": "2019-12-12 12:12:12" /*时间*/
  }
}
```
