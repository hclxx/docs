...
|   名称   |  类型  | 必须 |                      说明                      |
| :------: | :----: | :--: | :--------------------------------------------: |
|   type   | string |  是  |            收款方式:2-支付宝/3-USDT            |
|   name   | string |  否  |      type 为 2 为支付宝姓名必须,3 无需传       |
|  number  | string |  否  | type 为 2 为支付宝账号必须,3 为冲币地址 无需传 |
| code_pic | string |  否  |     type 为 2 为支付宝收款码必须,3 无需传      |
