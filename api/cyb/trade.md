...
```json
{
  ...
  "data": {
    ...
    "node_service_fee": "10", /*节点资产手续费比例*/
    "trade_service_fee": "10" /*交易资产手续费比例*/
  }
}
```
...
| balance_type | String | 否       | 资产类型，卖出必须，node-节点资产/trade-交易资产             |
...
| balance_type | String | 否       | 资金类型: (need_type=1 并且 pay_type 不等于 3) 必须          |
